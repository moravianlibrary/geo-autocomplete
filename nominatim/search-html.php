...
<head>
<!--
Výsledek projektu TEMAP - Technologie pro zpřístupnění mapových sbírek ČR: metodika a software pro ochranu a využití kartografických děl národního kartografického dědictví (kód DF11P01OVV003) Programu aplikovaného výzkumu a vývoje národní a kulturní identity (NAKI).
-->
	<title>Strukturované geografické vyhledávání</title>

	<base href="<?php echo CONST_Website_BaseURL;?>" />
	<link href="nominatim.xml" rel="search" title="Nominatim Search" type="application/opensearchdescription+xml" />
        <script src="http://nominatim.mzk.cz/js/autocomplete.js"></script>
	...
	<div id="seachheader">
		<form accept-charset="UTF-8" action="<?php echo CONST_Website_BaseURL; ?>search.php" method="get">
			<table border="0" width="100%">
				<tr>
					<td valign="center" style="width:100px;"><img style="width:90px;" src="images/mzk.png"></td>
					<td valign="center" style="width:400px;">
<input type="search" placeholder="Find a place..." autofocus="autofocus" autocomplete="off" name="q" id="q" style="width:400px" value="<?php echo htmlspecialchars($sQuery);?>"/>
</td>
...
<?php
	foreach($aSearchResults as $iResNum => $aResult)
	{
		if ($aResult['aBoundingBox'])
		{
			...
			{
				echo ', ';
				javascript_renderData($aResult['aPolyPoints']);
			}
			echo ');'."\n";
		}
		else
...
<div id="log" style="width: 500px; height:200px;">
	</div>
<script>main();</script>
